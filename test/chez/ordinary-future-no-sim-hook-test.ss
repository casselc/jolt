...
(for-each
 ...
 '("install-controller!" "restore-controller!" "controller-errors"
   ...
   "restore-clock-controller!" "supervisor-mono-nanos"))
...
(for-each
 ...
 '(jolt-ffi-sim-hook jolt-ffi-install-sim-hook!
    ...
    jolt-sim-clock-top jolt-sim-mono-nanos
    jolt-sim-supervisor-mono-nanos-source jolt-sim-supervisor-mono-nanos
    jolt-sim-proceed-stack-cell
