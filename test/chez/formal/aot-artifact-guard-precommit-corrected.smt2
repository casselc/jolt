...
; Corrected artifact boundary: after every intervening hook and immediately
; before the first user form, one in-memory guard compares every sealed-route
; token and atomically commits selection. No filesystem/source reread exists.
;
