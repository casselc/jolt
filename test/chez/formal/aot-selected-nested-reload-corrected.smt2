...
; Corrected selected-generation policy: a nested reload request fails before the
; first provider mutation, stops the selected transaction, and cannot retry
; after the user-form phase has begun. No live source reread is modeled.
;
