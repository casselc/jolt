...
; Accepted bounded generation-routing contract: caller-bound publication tokens,
; sealed compile witnesses and dependency-generation tokens, plus loaded-provider
; conflict preflight. No mixed-generation user-form execution is reachable in
; this finite model, including when two immutable generations were concurrently
; published before selection.
;
