(ns jolt.ffi
  ...
  scalar result. Unlike a separate errno read, capture reads POSIX errno or
  Windows GetLastError in the foreign-call return path, before runtime work can
  overwrite it. foreign-callable is the inverse — it wraps a jolt fn as a
