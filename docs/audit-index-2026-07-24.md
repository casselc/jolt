...
| --- | --- | --- |
| Current upstream rebase | [`upstream-rebase-v0.5.10.md`](upstream-rebase-v0.5.10.md) | Replay of the complete proposal stack onto upstream v0.5.10, overlap decisions for upstream's Git-cache and AOT changes, fresh seed remint, 68-model proof revalidation, complete local Chez 10.4.1 gate, native Windows Git-cache correction, green four-job hosted validation, and the remaining immutable-devboot-generation follow-up. |
...
| Cross-repository proof custody | [`proof-custody-2026-07-26.md`](proof-custody-2026-07-26.md) | Exact canonical owners for core models, Ansatz sources, generated oracles, network/TCP/HTTP lifecycle proofs, Hegel evidence, and consumer semantic companions. It also records which old worktrees are provenance-only and which local packages still lack publication remotes. |
...
| Core runtime/platform behavior | [`executor-shutdown-invariants.md`](executor-shutdown-invariants.md), [`timed-deref-invariants.md`](timed-deref-invariants.md), [`windows-path-invariants.md`](windows-path-invariants.md), [`windows-toolchains-and-validation.md`](windows-toolchains-and-validation.md), and draft [PR #4](https://github.com/casselc/jolt/pull/4) | Executor admission/drain, rejected execution, strict timed-latch result selection across mutex reacquisition, cache-off source tests, absolute caller paths, Windows host-shim behavior, inherited MinGW packaging history, the future MSVC backend boundary, and source/runtime/package evidence lanes. |
...
| Byte/IO layering, protocol dispatch, and completion safety | [`bytes-io-completion-invariants.md`](bytes-io-completion-invariants.md), [RFD 0001](rfd/0001/README.md), the byte-window/protocol-dispatch/completion [checked models](../test/chez/formal), and the [proof-custody map](proof-custody-2026-07-26.md) | Separates core byte mechanisms, an incubating `jolt.bytes/Window`, jolt-net attempts/readiness, and jolt-tcp completion/lease policy. Records idiomatic collection behavior, exact interface-plus-arity dispatch, exact reify protocol membership, provisional cursor status, future-shaped observation without `Future` cancellation, explicit two-phase cancellation, bounded slice-containment and terminal-publication controls, and the Ansatz-to-EDN-to-Hegel lane. The Window/Cursor generators now live canonically in `jolt-bytes`; `jolt-bencode` owns its framing generator and models. |
| Network architecture/design | [`JOLT-NET-DESIGN-SPIKE.md`](https://github.com/casselc/jolt-tcp/blob/6a311ea8242c867f906ce164bd39d7f33a499a3f/docs/JOLT-NET-DESIGN-SPIKE.md), [`UPSTREAM-NOTES.md`](https://github.com/casselc/jolt-net/blob/a4a4deb6b757d5e86aeb941cf646927e21420df6/docs/UPSTREAM-NOTES.md), [`PLATFORM-COVERAGE.md`](https://github.com/casselc/jolt-net/blob/a4a4deb6b757d5e86aeb941cf646927e21420df6/docs/PLATFORM-COVERAGE.md), and [`CLOJURE-PLATFORM.md`](https://github.com/casselc/jolt-net/blob/a4a4deb6b757d5e86aeb941cf646927e21420df6/docs/CLOJURE-PLATFORM.md) | Original TCP/FFI extraction audit, independent Claude worktree reconciliation, accepted decisions, runtime support versus ABI-probe evidence, readiness versus completion, Windows W1-W5 evidence, and the generalized capability/SPI follow-on. |
| Socket and TCP lifecycle | [`socket-invariants.md`](https://github.com/casselc/jolt-net/blob/a4a4deb6b757d5e86aeb941cf646927e21420df6/docs/proofs/socket-invariants.md), [`reactor-lifecycle-invariants.md`](https://github.com/casselc/jolt-tcp/blob/6a311ea8242c867f906ce164bd39d7f33a499a3f/docs/proofs/reactor-lifecycle-invariants.md), and [`client-connection-invariants.md`](https://github.com/casselc/jolt-tcp/blob/6a311ea8242c867f906ce164bd39d7f33a499a3f/docs/proofs/client-connection-invariants.md) | Descriptor generations, close/lease ownership, wakeups, connect completion, handler admission, shutdown/drain, EOF visibility, outbound deadlines, cleanup, and native Windows x86-64 TCP composition. |
| HTTP protocol and capacity | [`UPSTREAM-IMPROVEMENTS.md`](https://github.com/casselc/jolt-http/blob/94b76695d14a3d0ebd4f5c897127c59efae7a4f9/docs/UPSTREAM-IMPROVEMENTS.md), [`http-fail-closed.md`](https://github.com/casselc/jolt-http/blob/94b76695d14a3d0ebd4f5c897127c59efae7a4f9/docs/proofs/http-fail-closed.md), and [`inline-resume-capacity.md`](https://github.com/casselc/jolt-http/blob/94b76695d14a3d0ebd4f5c897127c59efae7a4f9/docs/proofs/inline-resume-capacity.md) | Parser/framing boundaries, terminal EOF, response canonicalization, exactly-once sink finalization, causal write failure, queue capacity, enforced POSIX Hegel coverage, and real Windows x86-64 loopback HTTP evidence. |
| Hegel/core/FFI integration | [`UPSTREAM-IMPROVEMENTS.md`](https://github.com/chucklehead-dev/jolt-hegel/blob/25d7a1b7e06c7adcf12f6567fe22e32d67f5803a/docs/UPSTREAM-IMPROVEMENTS.md), [`CORE-JOLT-INTEGRATION-SPIKE.md`](https://github.com/chucklehead-dev/jolt-hegel/blob/25d7a1b7e06c7adcf12f6567fe22e32d67f5803a/docs/CORE-JOLT-INTEGRATION-SPIKE.md), [`ARCHITECTURE.md`](https://github.com/chucklehead-dev/jolt-hegel/blob/25d7a1b7e06c7adcf12f6567fe22e32d67f5803a/docs/ARCHITECTURE.md), and [`PLATFORM-COVERAGE.md`](https://github.com/chucklehead-dev/jolt-hegel/blob/25d7a1b7e06c7adcf12f6567fe22e32d67f5803a/docs/PLATFORM-COVERAGE.md) | Struct-by-value FFI, AOT identity, `clojure.test` reporting, static-link rejection, external upstream libhegel acquisition, versioned native-cache ownership, and native checksum/install evidence including Windows ARM64. Hegel remains a separate external library. |
...
| Git dependency acquisition | Draft [PR #6](https://github.com/casselc/jolt/pull/6), [`git-dependency-cache-invariants.md`](git-dependency-cache-invariants.md), `jolt.deps`, and `test/deps_test.clj` | Failed/partial clones, collisions, literal and relative coordinates, linked tools.gitlibs worktrees, replacement refs, sparse/index/submodule states, locking, non-destructive publication, recursive Windows `GIT_DIR` path budgets, and same-process transaction admission. The compact v3 protocol passes 183/183 on Linux and 185/185 on native Windows x86-64. Final-code hosted run 30414843309 is green on both Linux architectures, Windows ARM64 source runtime, and packaged Windows x86-64. An earlier run exposed overlap outside the durable publication lock; the corrected process monitor, SAT one-fault control, UNSAT exclusion query, and native stress evidence are recorded rather than treating an earlier local pass as sufficient. |
