...
JOLT-TARGETS-NEEDING-DEPS := \
  ...
  traceemit \
  shakesmoke smoke staticnativesmoke stateimage test testbin transient unit niodirectories niotemp unitcontext \
...
CI-GATES := submodules values corpus unit niodirectories niotemp documented grenadine mvnhttp readscaling vecscaling pipescaling chunkscaling printscaling complexity ioscaling hotscaling depssmoke taskssmoke depscpcache depsunit \
